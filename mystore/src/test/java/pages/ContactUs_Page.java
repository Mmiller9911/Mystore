...
public class ContactUs_Page extends BasePage{
	...
	public ContactUs_Page getContactUsPage() throws IOException {
		...
		getCurrentDriverWithoutInitialisation().get("http://www.webdriveruniversity.com/Contact-Us/contactus.html");
	...
	public ContactUs_Page confirmContactUsFormSubmissionWasSuccessful() throws Exception {
		WebElement thanksContactUsPage = getCurrentDriverWithoutInitialisation().findElement(By.xpath(".//*[@id='contact_reply']/h1"));
