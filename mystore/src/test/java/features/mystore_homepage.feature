...
Scenario: Login with a valid username and password
	Given I enter "matt.miller@mqmsolutions.com" in the username field
	And I enter "hunky123!" in the password field
	And I click the login button after entering login details
